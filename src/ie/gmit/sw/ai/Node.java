...
public class Node {
    ...
    public Node[] children(Node[][] maze){
        ...
        if (row > maze[0][0].getRow() && maze[this.getMazeRow() - 1][this.getMazeCol()].isWalkable()){
            System.out.println("Add North");
            children.add(maze[this.getMazeRow() - 1][this.getMazeCol()]); //Add North
        }
        if (row < maze[0][0].getRow() + maze.length - 1 && maze[this.getMazeRow() + 1][this.getMazeCol()].isWalkable()){
            System.out.println("Add South");
            children.add(maze[this.getMazeRow() + 1][this.getMazeCol()]); //Add South
        }
        if (col > maze[0][0].getCol() && maze[this.getMazeRow()][this.getMazeCol() - 1].isWalkable()){
            System.out.println("Add West");
            children.add(maze[this.getMazeRow()][this.getMazeCol() - 1]); //Add West
        }
        if (col < maze[0][0].getCol() + maze[this.getMazeRow()].length - 1 && maze[this.getMazeRow()][this.getMazeCol() + 1].isWalkable()){
            System.out.println("Add East");
            children.add(maze[this.getMazeRow()][this.getMazeCol() + 1]); //Add East
        }
