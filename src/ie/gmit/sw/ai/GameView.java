...
public class GameView extends JPanel implements ActionListener{
    ...
    private Maze maze; // instance of maze
    private Sprite[] sprites; // array of items
    ...
    public GameView(Maze maze) throws Exception{
        this.maze = maze; // initializing the maze
        // JComponents adjastments
